...
void ScorePage::scoreSlider_valueChanged(int value)
{
    changeSliderColor();
...
void ScorePage::emit_Score()
{
    int Score = ui->scoreSlider->value();
...
void ScorePage::changeSliderColor()
{
